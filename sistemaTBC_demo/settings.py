...
SECRET_KEY = 'django-insecure-6116uy40-+v_d9x*p^v_x8h-ienjerzj=8#(me(oqwex#79f(7'
...
# Custom user model (opcional para futuro)
# AUTH_USER_MODEL = 'usuarios.UsuariosUsuario'
