...
urlpatterns = [
    ...
    path('reportes/cohorte/descargar/', views.GenerarReporteCohorteView.as_view(), name='descargar_reporte_cohorte'),
    path('reportes/operacional/descargar/', views.GenerarReporteOperacionalView.as_view(), name='descargar_reporte_operacional'),
